...
- [2. 全体構成](#2-全体構成)
  - [2.1. ツールスタック](#21-ツールスタック)
  - [2.2. 実行フロー (VCS-driven Workflow)](#22-実行フロー-vcs-driven-workflow)
  - [2.3. AWSへの認証方式 (OIDC連携)](#23-awsへの認証方式-oidc連携)
- [3. Terraform コード設計](#3-terraform-コード設計)
  - [3.1. ファイル構成](#31-ファイル構成)
- [4. Terraform Cloud 運用設計](#4-terraform-cloud-運用設計)
  - [4.1. ワークスペース戦略](#41-ワークスペース戦略)
  - [4.2. 変数管理](#42-変数管理)
- [5. 運用ルール](#5-運用ルール)
- [6. 非機能要件への対応方針](#6-非機能要件への対応方針)
